...
def nmf_pytorch(V, W, H, n_iter, r):
...
def audio_mosaic_pytorch(target_file, source_file, n_iter, r):
    ...
    H_updated = nmf_pytorch(V, W, H, n_iter, r)
...
audio_mosaic, sample_rate = audio_mosaic_pytorch(target_file, source_file, iterations, rep_r)
